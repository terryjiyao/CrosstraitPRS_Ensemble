# Cross-Trait PRS Performance and Ensemble PRS
...
The analyses were conducted using data from the **All of Us Research Program (AoU)** and the **UK Biobank (UKB)**. PRS models were constructed from publicly available genome-wide association study (GWAS) summary statistics, including European-ancestry (**FinnGen**) and African-ancestry (**MVP**) GWAS resources.
